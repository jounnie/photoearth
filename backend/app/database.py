...
# --- PYTHON LERNEN: Konfiguration via Umgebungsvariablen ---
# os.environ.get("KEY", default) liest eine Umgebungsvariable.
# Umgebungsvariablen werden außerhalb des Codes gesetzt (Terminal, Docker, Fly.io Secrets).
# Standard: lokale SQLite-Datei. Auf Fly.io: sqlite:////data/photoearth.db (persistentes Volume)
DATABASE_URL = os.environ.get("DATABASE_URL", "sqlite:///./photoearth.db")
